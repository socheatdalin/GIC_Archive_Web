...
function Thesis() {
    ...
    async function fetchData() {
      try {
        const response = await axois.get(
          "http://localhost:3001/team_project/all"
        );
        ...
        setInputGit(data.github_url);
        setInputDesc(data.descr);
      } catch (error) {
  ...
  //     const response = await axois.get("http://localhost:3001/team_project/all");
  //     setName(response.data[0].project_name)
  //     setID(response.data[0].id)
  //     setDesc(response.data[0].descr)
  //     setInputTitle(response.data[0].title);
  //     setInputGit(response.data[0].github_url);
  //     setInputDesc(response.data[0].descr);
  // }

  // const handleView = async (project_id) => {

  //     await axois.get("http://localhost:3001/thesis/all/" + project_id)
  //         .then((result) => {
  //             console.log(result.data);
          ...
          <div className="card-body d-flex flex-row mb-3 justify-content-start grid gap-0 column-gap-5  ">
            ...
            <div className="information">
              ...
              <h6 className="text-primary text-opacity-75">
                Git Hub Link: {inputGit}{" "}
              </h6>
              <p className="text-secondary">{setDesc} </p>
