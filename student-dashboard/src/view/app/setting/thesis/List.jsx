...
>>>>>>> ed710967b6a4a0b46ed97592111187c1e60d1495
...
<<<<<<< HEAD
     ...
     const [Year, setGeneration] = React.useState('');
     ...
     const [inputGeneration1, setInputGeneration1] = React.useState('');
     ...
     const handleSelectGeneration = (e) => {
          setInputGeneration1(e);
          handleSort(inputGeneration1, e.value);
     };
     ...
     const handleView = async (thesis_id) => {
          await axios
               .get('http://localhost:3001/thesis/' + thesis_id)
               .then((result) => {
                    console.log(result.data);
                    setName(result.data[0].student_name);
                    setID(result.data[0].id);
                    setGeneration(result.data[0].generation);
          ...
          axios
               .post(
                    'http://localhost:3000/admin/create/course',
                    {
                         ...
                         // ToYear: inputToYear1,
                         Generations: inputGeneration1.value,
                         desc: inputDesc,
                         type: inputType,
                         photo: inputPhoto,
                    },
     ...
     const Thesis = async (email) => {
          axios.get('http://localhost:3001/student/thesis/' + email)
               .then((result) => {
                    console.log(email);
                    setThesis(result.data);
                    console.log(result.data);
     ...
     const handleDelete = async () => {
          axios
               .get('http://localhost:3000/admin/delete/course/' + deleteID, {
                    withCredentials: true,
               })
               .then((result) => {
                    window.location.replace('/thesis/list');
