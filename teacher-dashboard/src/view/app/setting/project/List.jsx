import { Center, Flex, Grid, IconButton, InputGroup, VStack, background, useDisclosure, } from '@chakra-ui/react';
     ...
     const handleSubmit = async () => {
          ...
          try {
               ...
               const results = await axios.post(
                    "http://localhost:3001/teacher/project/create/" + result.data.teacher_id,
                    formData
               );
                              ...
                              <VStack spacing="3">
                                   <FormControl sx={{ width: '300px' }}>
                                        ...
                                        <select
                                             ...
                                             style={{ height: '30px', marginTop: '10px', borderBloc: '1px' }}
                                             required
                                        >
                                             <option key="default">choose student</option>
                                             {students.map((student, index) => (
                                                  <option key={index}>{student.fullname}</option>
                                             ))}
                                        </select> */}
