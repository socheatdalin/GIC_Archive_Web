...
export default function List() {
  ...
  const handleSearch = (e) => {
    // console.log(search)
    axios
      .post('http://localhost:3001/admin/thesis/all/field', {
        field: inputField,
      })
      .then((result) => {
  ...
  const handleDisplay = async () => {
    const response = await axios.get(
      'http://localhost:3001/admin/team_project/all'
    );
            ...
            >
              ...
              >
                <div style={{ marginTop: '10px' }}>
                  ...
                  <span style={{ marginLeft: '170px', color: '#517388' }}>
                    {inputTitle}
                  </span>
                </div>
                <div style={{ marginTop: '10px' }}>
                  ...
                  <span style={{ marginLeft: '95px', color: '#517388' }}>
                    {inputName}
                  </span>
                </div>
                <div style={{ marginTop: '10px' }}>
                  ...
                  <span style={{ marginLeft: '75px', color: '#517388' }}>
                    {InputTeacherName}
                  </span>
                </div>
                ...
                <div style={{ marginTop: '10px' }}>
                  ...
                  <span style={{ marginLeft: '150px', color: '#517388' }}>
                    {inputCompany}
                  </span>
                </div>
                <div style={{ marginTop: '10px' }}>
                  ...
                  <span style={{ marginLeft: '180px', color: '#517388' }}>
                    {inputTag}
                  </span>
                </div>
                <div style={{ marginTop: '10px' }}>
                ...
                <div style={{ marginTop: '20px', display: 'flex' }}>
                  ...
                  <button
                    onClick={() =>
                      handleOpenFile(
                        `http://localhost:3001/static/${inputFile}`
                      )
                    }
                    style={{
                      marginLeft: '180px',
